...
from scripts.config import SEQ_SRC, DOWNLOAD_SEQS, ATTR_FILE, ATTR_LIST_FILE, GT_FILE, DOWNLOAD_URL, INIT_OMIT_FILE, \
ATTR_DESC_FILE, TB_50_FILE, TB_100_FILE, CVPR_13_FILE
...
def get_sub_seqs(s, numSeg, evalType):
    ...
    if evalType == 'OPE':
        ...
        for i in range(len(shiftTypeSet)):
            ...
            s.init_rect = scripts.butil.shift_init_BB(s.init_rect, shiftType, imgHeight, imgWidth)
